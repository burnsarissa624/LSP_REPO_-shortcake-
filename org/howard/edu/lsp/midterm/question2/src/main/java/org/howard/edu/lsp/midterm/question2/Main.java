...
public class Main {
  ...
  /*
   * Using method overloading keeps one clear method name, “area,” with different
   * parameters. It’s cleaner and avoids repetitive names like circleArea() or
   * rectangleArea() for each shape.
   */
}
